    ...
    <>
      ...
      <main>
        ...
        <div className="grid">
          ...
          <Link className="card" to="/nienke">
            <span className="card__label">Nienke</span>
            <h2 className="card__title">Visualisatie Nienke</h2>
            <p className="card__desc">Persoonlijk visualisatieproject van Nienke.</p>
            <span className="card__link">Bekijken →</span>
          </Link>
        </div>
      </main>
